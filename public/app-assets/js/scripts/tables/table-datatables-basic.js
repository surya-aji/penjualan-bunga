...
$(function () {
  ...
  var dt_basic_table = $('.datatables-basic'),
   dt_basic_table_supp = $('#suppTB'),
   dt_basic_table_prd = $('#prdTB'),
   dt_basic_table_ktg = $('#ktgTB'),
   dt_basic_table_lp = $('#lpTB'),
  ...
  // ========================= SUPPLIER TABLES
  if (dt_basic_table_supp.length) {
    var dt_basic = dt_basic_table_supp.DataTable({
      ajax:{
  ...
  // ========================= PRD TABLES
  if (dt_basic_table_prd.length) {
    var dt_basic = dt_basic_table_prd.DataTable({
      ajax: assetPath + 'data/table-datatable.json',
      columns: [
        { data: 'responsive_id' },
        { data: 'id' },
      ...
      buttons: [
        ...
        // },
        {
          text: feather.icons['plus'].toSvg({ class: 'mr-50 font-small-4' }) + 'Tambah Produk',
          className: 'create-new btn btn-primary',
          attr: {
            'data-toggle': 'modal',
            'data-target': '#modals-slide-in'
  ...
  // ========================= KTG TABLES
  if (dt_basic_table_ktg.length) {
    var dt_basic = dt_basic_table_ktg.DataTable({
      ajax: assetPath + 'data/table-datatable.json',
      columns: [
        { data: 'responsive_id' },
        { data: 'id' },
  ...
  // ========================= LP TABLES
  if (dt_basic_table_lp.length) {
    var dt_basic = dt_basic_table_lp.DataTable({
      ajax: assetPath + 'data/table-datatable.json',
      columns: [
        { data: 'responsive_id' },
        { data: 'id' },

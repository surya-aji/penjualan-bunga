            ...
            <div class="content-body">
                ...
                <div class="misc-wrapper"><a class="brand-logo" href="javascript:void(0);">
                    ...
                    <div class="misc-inner p-2 p-sm-3">
                        ...
                        </p><a class="btn btn-primary mb-1 btn-sm-block" href="{{ route('logout') }}" onclick="event.preventDefault();
                        document.getElementById('logout-form').submit();">Back to login</a><img class="img-fluid" src="{{asset('app-assets/images/pages/not-authorized.svg')}}" alt="Not authorized page" />
